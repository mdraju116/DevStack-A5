  ...
  return (
    <div className="bg-white border border-[#e2e8f0] rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 h-full">
      <div className="p-5 flex flex-col h-full">
        ...
        <div className="grid grid-cols-3 items-center gap-2 mt-5 w-full">

          <div className="min-w-0">
            <span className="block w-full text-center px-1.5 py-1 rounded-md bg-[#f1f5f9] text-[#64748b] text-[9px] whitespace-nowrap overflow-hidden">
              {technology.category}
            </span>
          </div>

          <div className="min-w-0">
            <span className="block w-full text-center px-1.5 py-1 rounded-md border border-[#e2e8f0] text-[#64748b] text-[9px] whitespace-nowrap overflow-hidden">
